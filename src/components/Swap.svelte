    ...
    <div class = 'swap_container'>
        ...
        {#if tokenName != '' && tokenName2 != '' && inputAmountTok1 != 0 && inputAmountTok2 != 0}
            <div class = 'gas_fee_container' transition:fade>
                <div class = 'gas_text'><span class = 'tooltiptext' transition:fade>Gas Fee </span><div class = 'gas'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-fuel-pump" viewBox="0 0 16 16">
